...
// Install if needed: npm install @shopify/app-bridge-react
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  // Extract host from URL query params (required for embedded Shopify apps)
  // Safe in 'use client' component
  ...
  return (
    <html lang="en">
      <head>
        {/* Shopify Embedded App Bridge – must be in <head> of every page */}
