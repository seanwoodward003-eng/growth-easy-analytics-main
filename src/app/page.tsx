...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen px-6 py-20 text-center bg-gradient-to-b from-black to-[#0a0f2c]">
      ...
      {/* Guarantee — Removed money-back, replaced with stronger copy */}
      <div className="max-w-4xl mx-auto mt-32 text-gray-300 text-xl space-y-6">
        <p className="text-3xl font-bold text-cyan-400">
          Instant activation — no waiting, no approval
        </p>
        <p>
          Lifetime plans include the current version + bug fixes forever + 12 months of all future major features.
        </p>
        <p className="text-2xl text-purple-400 font-bold">
          Price increases as we grow — lock in today's rate forever
        </p>
      </div>
    </div>
  );
