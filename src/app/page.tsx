  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#0a0f2c] via-[#0f1a3d] to-black flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12 text-center relative overflow-hidden">
      <div className="w-full max-w-xl sm:max-w-3xl lg:max-w-6xl mx-auto z-10 space-y-12 sm:space-y-16 lg:space-y-20">
        ...
        {/* Hero Title */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-9xl font-black bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent glow-title leading-tight">
          GROWTHEASY AI
        </h1>

        <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-cyan-300">
          AI-Powered Growth Intelligence for Your Store
        </p>

        <p className="text-lg sm:text-xl md:text-2xl text-cyan-200 max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 sm:gap-6 items-center">
            <input
              type="email"
        ...
        <div className="space-y-4 sm:space-y-6">
          <p className="text-3xl sm:text-4xl md:text-5xl font-black text-red-400 animate-pulse">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
          <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-cyan-900/20 to-purple-900/20 border border-cyan-500/30 backdrop-blur-md">
            <h3 className="text-2xl sm:text-3xl font-black text-cyan-300 mb-4 sm:mb-6">Real-Time Analytics</h3>
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-500/30 backdrop-blur-md">
            <h3 className="text-2xl sm:text-3xl font-black text-purple-300 mb-4 sm:mb-6">AI Growth Coach</h3>
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-pink-900/20 to-cyan-900/20 border border-pink-500/30 backdrop-blur-md">
            <h3 className="text-2xl sm:text-3xl font-black text-pink-300 mb-4 sm:mb-6">Cyberpunk Design</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
            <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-cyan-900/30 to-black border-4 border-cyan-400">
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-purple-900/30 to-black border-4 border-purple-500">
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-green-900/30 to-black border-4 border-green-500">
