// frontend/script.js — FINAL LIVE VERSION (Vercel + Render)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // === DYNAMIC API BASE (LOCAL DEV vs PRODUCTION) ===
  const API_BASE = window.location.hostname === 'localhost'
    ? 'http://localhost:8000'  // For local testing
    : 'https://growth-easy-analytics-2.onrender.com';  // YOUR RENDER BACKEND
