  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center bg-gradient-to-br from-dark to-black">
      ...
      <div className="flex items-center gap-6 mb-12">
        <img src="https://x.ai/grok-badge.png" alt="Powered by Grok xAI" className="h-12" />
      ...
      <div className="my-20 bg-black/70 border-4 border-neon rounded-3xl p-16 max-w-4xl">
        ...
        <p className="text-4xl text-red-400 animate-pulse mb-8">
          Only ~418 of 500 lifetime spots left
        </p>
        <p className="text-2xl mb-10">
          When 500 sell → price becomes £97/month forever
        </p>
        <a
          href="https://buy.stripe.com/your_37_lifetime_link_here"
      ...
      <p className="text-xl mt-20 text-cyan-400">
        First 100 get a personal walkthrough from the founder
      </p>
    </div>
  );
}