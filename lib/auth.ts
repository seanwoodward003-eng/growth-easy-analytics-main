...
import { requireAuth } from '@/lib/auth'; // ← Now correctly imported
...
export async function POST(request: NextRequest) {
  ...
  // Get current user (your real auth)
  ...
  console.log('[CHAT] Authenticated user ID:', userId);
  ...
  // ────────────────────────────────────────────────────────────────
  // FETCH METRICS (only change – injects real data for Grok)
  // ────────────────────────────────────────────────────────────────
